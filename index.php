...
$faqs = [
    ...
    [
        ...
        <ol class='alpha'><li>Google Ireland Limited, if you’re located in the European Economic Area (EU countries plus Iceland, Liechtenstein, and Norway) or Switzerland</li>
...
<body>
    <header>
        <div class="logo">
            <img src="img\logoGoogle (1).png" alt="logo">
            <h3>Privacy & terms</h3>
        </div>
        <ul>
